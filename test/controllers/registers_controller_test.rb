...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { lastname: @register.lastname, name: @register.name } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { lastname: @register.lastname, name: @register.name } }
